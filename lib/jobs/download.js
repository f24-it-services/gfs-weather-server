...
function install(schedule) {
  cronConfig = _Config2.default.get().downloader;

  schedule(cronConfig.schedule || '1 0,12 * * *', function () {
    (0, _db.bootstrap)();
    ...
    var start = function start(startDate) {
      var config = Object.assign({}, cronConfig, { fields: [] });
      cronConfig.fields.forEach(function (field) {
